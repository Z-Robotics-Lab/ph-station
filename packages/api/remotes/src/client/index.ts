...
import boardRemote from '@deepseek-ai/dsh-ph-board/remote'
import brainRemote from '@deepseek-ai/dsh-ph-brain/remote'
...
export type {} from '@deepseek-ai/dsh-ph-board/remote'
export type {} from '@deepseek-ai/dsh-ph-brain/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, boardRemote, brainRemote, messageFeedbackRemote, sessionReferencesRemote,
    ]) {
