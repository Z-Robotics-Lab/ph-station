/** Shared panel chrome for the phpanels tabs: a self-explanatory title + one-line
 * subtitle head, an empty-state explainer card, and a jargon label with a `?`
 * tooltip badge. Local to this package on purpose — the ph panel packages stay
 * decoupled rather than share a chrome library. */
...
/** An explainer shown in place of data when a panel has nothing to show yet. */
