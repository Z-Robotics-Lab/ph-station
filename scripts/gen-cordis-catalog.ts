...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  BoardRuntimeFrameRequest: 'name-addressed board frame request is owned by packages/host/dsh-ph-board/src/types.ts',
  BoardRuntimeKeyframeRequest: 'name-addressed board keyframe request is owned by packages/host/dsh-ph-board/src/types.ts',
  BoardPlanSkillTaskRequest: 'natural-language planning request is owned by packages/host/dsh-ph-board/src/types.ts',
  BoardSubmitSkillPlanRequest: 'verified-plan submit request is owned by packages/host/dsh-ph-board/src/types.ts',
  BoardBriefRequest: 'brief lifecycle request is owned by packages/host/dsh-ph-board/src/types.ts',
