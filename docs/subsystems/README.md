...
| [ph-board.md](ph-board.md) | this fork's read-only `ctx.board` bridge from the ph-station panels to the physical-harness evidence layer: name-addressed store/session reads forwarded verbatim from `board/storecli.py` |
